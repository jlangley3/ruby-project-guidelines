...
avengers_1 = Comic.find_or_create_by(name: "Avengers 1", publish_date: 1998, series: avengers_series, author: "Dr. Seuss", storyline: "This is a whole new another storyline")
avengers_2 = Comic.find_or_create_by(name: "Avengers 2", publish_date: 2018, series: avengers_series, author: "J.K. Rowling", storyline: "This is yet another storyline")

spidey_1 = Comic.find_or_create_by(name: "Spidey 1", publish_date: 1988, series: spidey_series, author: "Walt Whitman", storyline: "This is another storyline")
spidey_2 = Comic.find_or_create_by(name: "Spidey 2", publish_date: 2005, series: spidey_series, author: "Toni Morrison", storyline: "This is the storyline")
